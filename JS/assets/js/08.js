...
var age = prompt("Bonjour! Quel est votre âge?", "<Saisir votre âge?>");
...
if(monUtilisateurEstMajeur(age)) {
    ...
    document.location.href = 'http://lmgtfy.com/?q=majorite+legale+en+france';
}
*/
/*----------------------------------------
